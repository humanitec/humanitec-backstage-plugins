          ...
          <>
            <Box>
              <Typography
                component="span"
                color="textSecondary"
                className={classes.miniCardSubTitle}
              >
                host:{' '}
              </Typography>
              <Typography
                ...
                color="textPrimary"
                className={classes.miniCardSubTitle}
                href={`https://${resource.resource.host}`}
              >
  ...
  switch (status) {
    case 'active':
      return (
        <Typography
          component="span"
          className={`${classes.miniCardSubTitle} ${classes.successColor}`}
        >
          Active
        </Typography>
      );
    case 'pending':
      return (
        <Typography
          component="span"
          className={`${classes.miniCardSubTitle} ${classes.pendingColor}`}
        >
          Pending
        </Typography>
      );
    ...
    default:
      return (
        <Typography
          component="span"
          className={`${classes.miniCardSubTitle} ${classes.unknownColor}`}
        >
          Unknown
        </Typography>
      );
...
function isActiveDnsResource(
  resource: Resource,
): resource is Resource & { resource: { host: string; ip_address: string } } {
  return (
    !!resource.resource &&
    resource.type === 'dns' &&
