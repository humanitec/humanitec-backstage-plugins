...
npx --yes @janus-idp/cli@1.8.5 package export-dynamic-plugin --embed-as-dependencies --clean --no-in-place
...
npx --yes @janus-idp/cli@1.8.5 package export-dynamic-plugin --embed-as-dependencies --clean
